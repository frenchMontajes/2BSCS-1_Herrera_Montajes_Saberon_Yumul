  ...
  return (
    <div className="container py-16 px-4" style={{ backgroundImage: "url('12334.jpg')", backgroundSize: "cover", 
      ...
      <div className="flex flex-col md:flex-row items-center">
        <div className="max-w-full md:max-w-2xl text-left text-white md:pr-10 md:pl-20 ml-8 mt-12 
        relative rounded-xl overflow-hidden py-8">
          <div className="absolute inset-0 bg-black opacity-50"></div>
          <h1 className="text-5xl mb-8 relative z-10 font-semibold" style={{ fontFamily: "Open Sans, sans-serif" }}>
            About Us
          </h1>
          <p className="text-lg leading-relaxed relative z-10" style={{ fontFamily: "Open Sans, sans-serif", fontWeight: 400 }}>
        ...
        <div className="max-w-full md:max-w-xl ml-4 md:ml-24 mt-12 mr-4 md:mr-14">
